package com.fontana.rabbitmq.client;
...
import com.fontana.rabbitmq.event.MyRemoteApplicationEvent;
import com.fontana.rabbitmq.exchange.DelayExchangeBuilder;
...
public class RabbitMqClient {
    ...
    public void publishEvent(String handlerName, BaseMap baseMap) {
        ...
        publisher.publishEvent(new MyRemoteApplicationEvent(eventObj, busProperties.getId()));
    }
