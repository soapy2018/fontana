...
import com.bluetron.nb.common.onlineservice.mapper.OnlinePageMapper;
...
public class OnlinePageServiceImpl extends ABaseService<OnlinePage, Long> implements OnlinePageService {
    ...
    public OnlinePage saveNew(OnlinePage onlinePage) {
        onlinePage.setPageId(IdUtil.nextLongId());
        Date now = new Date();
