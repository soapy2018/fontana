...
import com.bluetron.nb.common.onlineservice.mapper.OnlineRuleMapper;
...
public class OnlineRuleServiceImpl extends ABaseService<OnlineRule, Long> implements OnlineRuleService {
    ...
    public OnlineRule saveNew(OnlineRule onlineRule) {
        onlineRule.setRuleId(IdUtil.nextLongId());
        Date now = new Date();
