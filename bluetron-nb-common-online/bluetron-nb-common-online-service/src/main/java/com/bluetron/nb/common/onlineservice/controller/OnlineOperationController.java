...
@Slf4j
@RestController
@ConditionalOnProperty(name = "bluetron-nb-common.common-online.operationEnabled", havingValue = "true")
@RequestMapping("${bluetron-nb-common.common-online.operationUrlPrefix}/onlineOperation")
