...
public class OnlineDatasource {
    ...
    public interface OnlineDatasourceModelMapper extends BaseEntityMapper<OnlineDatasourceVo, OnlineDatasource> {
         ...
         * @return 实体对象。
         */
        @Mapping(target = "onlinePageDatasource", expression = "java(mapToBean(onlineDatasourceVo.getOnlinePageDatasource(), com.bluetron.nb.common.onlineservice.entity.OnlinePageDatasource.class))")
        @Override
