 ...
 */
@Data
@TableName(value = "bn_online_rule")
public class OnlineRule {
    ...
    public interface OnlineRuleModelMapper extends BaseModelMapper<OnlineRuleVo, OnlineRule> {
         ...
         * @return 实体对象。
         */
        @Mapping(target = "onlineColumnRule", expression = "java(mapToBean(onlineRuleVo.getOnlineColumnRule(), com.bluetron.nb.common.onlineservice.entity.OnlineColumnRule.class))")
        @Override
