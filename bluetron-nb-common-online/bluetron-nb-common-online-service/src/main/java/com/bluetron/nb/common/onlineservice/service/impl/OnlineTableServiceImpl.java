...
import com.bluetron.nb.common.onlineservice.mapper.OnlineTableMapper;
...
public class OnlineTableServiceImpl extends ABaseService<OnlineTable, Long> implements OnlineTableService {
    ...
    public OnlineTable saveNewFromSqlTable(SqlTable sqlTable) {
        ...
        onlineTable.setTableId(IdUtil.nextLongId());
