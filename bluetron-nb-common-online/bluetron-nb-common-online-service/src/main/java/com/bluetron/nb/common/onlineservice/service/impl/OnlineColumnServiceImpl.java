...
import com.bluetron.nb.common.onlineservice.entity.OnlineColumnRule;
import com.bluetron.nb.common.onlineservice.mapper.OnlineColumnMapper;
import com.bluetron.nb.common.onlineservice.mapper.OnlineColumnRuleMapper;
...
public class OnlineColumnServiceImpl extends ABaseService<OnlineColumn, Long> implements OnlineColumnService {
    ...
    public List<OnlineColumn> saveNewList(List<SqlTableColumn> columnList, Long onlineTableId) {
        ...
        for (SqlTableColumn column : columnList) {
            ...
            onlineColumn.setColumnId(IdUtil.nextLongId());
