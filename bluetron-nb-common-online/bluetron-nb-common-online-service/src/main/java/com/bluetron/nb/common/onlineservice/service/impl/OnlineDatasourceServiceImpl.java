...
import com.bluetron.nb.common.onlineservice.mapper.OnlineDatasourceMapper;
import com.bluetron.nb.common.onlineservice.mapper.OnlineDatasourceTableMapper;
import com.bluetron.nb.common.onlineservice.mapper.OnlinePageDatasourceMapper;
import com.bluetron.nb.common.onlineservice.entity.OnlineDatasource;
import com.bluetron.nb.common.onlineservice.entity.OnlineDatasourceTable;
import com.bluetron.nb.common.onlineservice.entity.OnlinePageDatasource;
...
import com.bluetron.nb.common.onlineservice.service.OnlineDatasourceRelationService;
...
public class OnlineDatasourceServiceImpl extends ABaseService<OnlineDatasource, Long> implements OnlineDatasourceService {
    ...
    public OnlineDatasource saveNew(OnlineDatasource onlineDatasource, SqlTable sqlTable, Long pageId) {
        ...
        onlineDatasource.setDatasourceId(IdUtil.nextLongId());
        ...
        datasourceTable.setId(IdUtil.nextLongId());
        ...
        onlinePageDatasource.setId(IdUtil.nextLongId());
