...
public class OnlineDatasourceRelation {
    ...
    public interface OnlineDatasourceRelationModelMapper
         ...
         * @return 实体对象。
         */
        @Mapping(target = "masterColumn", expression = "java(mapToBean(onlineDatasourceRelationVo.getMasterColumn(), com.bluetron.nb.common.onlineservice.entity.OnlineColumn.class))")
        @Mapping(target = "slaveTable", expression = "java(mapToBean(onlineDatasourceRelationVo.getSlaveTable(), com.bluetron.nb.common.onlineservice.entity.OnlineTable.class))")
        @Mapping(target = "slaveColumn", expression = "java(mapToBean(onlineDatasourceRelationVo.getSlaveColumn(), com.bluetron.nb.common.onlineservice.entity.OnlineColumn.class))")
        @Override
