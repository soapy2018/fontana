...
import com.bluetron.nb.common.onlineservice.mapper.OnlineDatasourceRelationMapper;
...
public class OnlineDatasourceRelationServiceImpl
        extends ABaseService<OnlineDatasourceRelation, Long> implements OnlineDatasourceRelationService {
    ...
    public OnlineDatasourceRelation saveNew(
        ...
        // 查找数据源关联的数据表，判断当前关联的从表，是否已经存在于bn_online_datasource_table中了。
        ...
        relation.setRelationId(IdUtil.nextLongId());
