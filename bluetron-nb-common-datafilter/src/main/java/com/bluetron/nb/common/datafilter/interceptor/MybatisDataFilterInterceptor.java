package com.bluetron.nb.common.datafilter.interceptor;
...
public class MybatisDataFilterInterceptor implements Interceptor {
    ...
    public void loadInfoWithDataFilter() {
        Map<String, BaseDaoMapper> mapperMap =
                SpringContextHolder.getApplicationContext().getBeansOfType(BaseDaoMapper.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        if (!DataFilterThreadLocal.enabledDataFilter()) {
        ...
        if (WebContextUtil.takeTokenFromRequest() == null) {
            return invocation.proceed();
        }
    ...
    private void processDataPermFilter(
        ...
        if (StringUtils.isBlank(dataPermData)) {
            throw new GeneralException("No Related DataPerm found for SQL_ID [ " + sqlId + " ].");
        }
