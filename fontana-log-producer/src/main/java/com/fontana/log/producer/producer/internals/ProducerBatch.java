...
import com.fontana.log.producer.producer.*;
import com.fontana.log.producer.producer.errors.ResultFailedException;
...
public class ProducerBatch implements Delayed {
  ...
  private final List<BaseLogItem> logItems = new ArrayList<BaseLogItem>();
  ...
  public ListenableFuture<Result> tryAppend(BaseLogItem item, int sizeInBytes, Callback callback) {
  ...
  public ListenableFuture<Result> tryAppend(
      List<BaseLogItem> items, int sizeInBytes, Callback callback) {
  ...
  public List<BaseLogItem> getLogItems() {
    return logItems;
  }
