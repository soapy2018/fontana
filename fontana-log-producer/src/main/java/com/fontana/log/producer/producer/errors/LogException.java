...
public class LogException extends Exception {
   ...
   * @param requestId request id from sls server, if the error is happened in the client, the
   *                  request id is empty
   */
   ...
   * Get the request id
   *
   * @return request id, if the error is happened in the client, the request id is empty
   */
