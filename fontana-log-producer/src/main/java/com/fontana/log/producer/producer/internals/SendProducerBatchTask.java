...
import com.fontana.log.producer.producer.errors.Errors;
import com.fontana.log.producer.producer.errors.LogException;
import com.fontana.log.producer.producer.errors.RetriableErrors;
...
public class SendProducerBatchTask implements Runnable {
  ...
  private final Map<String, LogStoreClient> clientPool;
  ...
  public SendProducerBatchTask(
      ...
      Map<String, LogStoreClient> clientPool,
  ...
  private void sendProducerBatch(long nowMs) throws InterruptedException {
    ...
    LogStoreClient client = getClient(project);
    if (client == null) {
  ...
  private LogStoreClient getClient(String project) {
