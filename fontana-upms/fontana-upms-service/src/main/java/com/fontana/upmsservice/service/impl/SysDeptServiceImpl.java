...
import com.fontana.upmsservice.mapper.SysDeptMapper;
import com.fontana.upmsservice.mapper.SysDeptPostMapper;
import com.fontana.upmsservice.mapper.SysDeptRelationMapper;
...
public class SysDeptServiceImpl extends AbstractBaseService<SysDept, Long> implements SysDeptService {
    ...
    public boolean updateSysDeptPost(SysDeptPost sysDeptPost) {
        ...
        UpdateWrapper<SysDeptPost> uw =
                AbstractBaseService.createUpdateQueryForNullValue(sysDeptPost, SysDeptPost.class);
        uw.setEntity(filter);
