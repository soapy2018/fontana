...
public interface CommonConstants {
     ...
     * TRACE log日志
     */
    String TRACELOG_PREFIX = "bluetron-nb-common.tracelog";
     ...
     * datafilter配置
     */
    String DATAFILTER_PREFIX = "bluetron-nb-common.datafilter";

    /**
     * application配置
     */
    String APPLICATION_PREFIX = "bluetron-nb-common.application";

    /**
     * online配置
     */
    String COMMON_ONLINE_PREFIX = "bluetron-nb-common.common-online";

    /**
     * flow配置
     */
    String COMMON_FLOW_PREFIX = "bluetron-nb-common.common-flow";
