...
public class SysPermCode extends BaseEntity {
    ...
    @Mapper
    public interface SysPermCodeModelMapper extends BaseEntityMapper<SysPermCodeVo, SysPermCode> {
        /**
         * 转换VO对象到实体对象。
         *
         ...
         * @return 实体对象。
         */
        @Mapping(target = "sysPermCodePermList", expression = "java(mapToBean(sysPermCodeVo.getSysPermCodePermList(), com.bluetron.nb.common.upmsservice.entity.SysPermCodePerm.class))")
        @Override
