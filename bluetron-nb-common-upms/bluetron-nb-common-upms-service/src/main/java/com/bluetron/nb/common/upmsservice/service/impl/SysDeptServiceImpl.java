...
import com.bluetron.nb.common.upmsservice.entity.*;
import com.bluetron.nb.common.upmsservice.mapper.SysDataPermDeptMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysDeptMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysDeptPostMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysDeptRelationMapper;
...
public class SysDeptServiceImpl extends ABaseService<SysDept, Long> implements SysDeptService {
    ...
    public SysDept saveNew(SysDept sysDept, SysDept parentSysDept) {
        sysDept.setDeptId(IdUtil.nextLongId());
    ...
    public void addSysDeptPostList(List<SysDeptPost> sysDeptPostList, Long deptId) {
        for (SysDeptPost sysDeptPost : sysDeptPostList) {
            sysDeptPost.setDeptPostId(IdUtil.nextLongId());
