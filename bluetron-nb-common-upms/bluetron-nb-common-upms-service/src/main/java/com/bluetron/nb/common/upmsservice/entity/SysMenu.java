...
public class SysMenu extends BaseEntity {
    ...
    public interface SysMenuModelMapper extends BaseEntityMapper<SysMenuVo, SysMenu> {
         ...
         * @return 实体对象。
         */
        @Mapping(target = "sysMenuPermCodeList", expression = "java(mapToBean(sysMenuVo.getSysMenuPermCodeList(), com.bluetron.nb.common.upmsservice.entity.SysMenuPermCode.class))")
        @Override
