...
import com.bluetron.nb.common.upmsservice.entity.SysUserPost;
import com.bluetron.nb.common.upmsservice.mapper.SysDeptPostMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysPostMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysUserPostMapper;
...
public class SysPostServiceImpl extends ABaseService<SysPost, Long> implements SysPostService {
    ...
    public SysPost saveNew(SysPost sysPost) {
        sysPost.setPostId(IdUtil.nextLongId());
