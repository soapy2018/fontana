...
import com.bluetron.nb.common.upmsservice.entity.SysMenuPermCode;
import com.bluetron.nb.common.upmsservice.entity.SysRoleMenu;
import com.bluetron.nb.common.upmsservice.mapper.SysMenuMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysMenuPermCodeMapper;
import com.bluetron.nb.common.upmsservice.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl extends ABaseService<SysMenu, Long> implements SysMenuService {
    ...
    public SysMenu saveNew(SysMenu sysMenu, Set<Long> permCodeIdSet) {
        sysMenu.setMenuId(IdUtil.nextLongId());
        ...
        if (sysMenu.getOnlineFormId() != null) {
            ...
            viewSubMenu.setMenuId(IdUtil.nextLongId());
            ...
            editSubMenu.setMenuId(IdUtil.nextLongId());
