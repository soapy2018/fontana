...
public class JacksonMapper extends ObjectMapper {
	...
	public static String toJson(Object object){
		return JacksonMapper.getInstance().toJsonString(object);
	}
	...
	public static <T> T fromJson(String jsonString, Class<T> clazz){
		return JacksonMapper.getInstance().fromJsonString(jsonString, clazz);
	}
	...
	public static <T> T fromJson(String jsonString , TypeReference<T> valueTypeRef) {
		return JacksonMapper.getInstance().fromJsonString(jsonString, valueTypeRef);
	}
