...
import com.bluetron.nb.common.util.codec.Base64Util;
import com.bluetron.nb.common.util.codec.DigestUtil;
import com.bluetron.nb.common.util.date.DateTimeUtil;
import com.bluetron.nb.common.util.json.JacksonMapperUtil;
import com.bluetron.nb.common.util.json.JsonUtil;
import com.bluetron.nb.common.util.lang.NumberUtil;
...
public class SupUtil {
	...
	public static <T> boolean contains(@Nullable T[] array, final T element) {
		return CollectionUtils.containsAny(Arrays.asList(array), element);
	}
	...
	public static String randomUUID() {
		return IdUtil.simpleRandomUUID();
	}
	...
	public static String toJson(Object object) {
		return JacksonMapperUtil.toJson(object);
	}
	...
	public static byte[] toJsonAsBytes(Object object) {
		return JacksonMapperUtil.toJsonAsBytes(object);
	}
