...
import com.bluetron.nb.common.flowservice.mapper.FlowCategoryMapper;
...
public class FlowCategoryServiceImpl extends ABaseService<FlowCategory, Long> implements com.bluetron.nb.common.flowservice.service.FlowCategoryService {
    ...
    public FlowCategory saveNew(FlowCategory flowCategory) {
        flowCategory.setCategoryId(IdUtil.nextLongId());
    ...
    public boolean update(FlowCategory flowCategory, FlowCategory originalFlowCategory) {
        flowCategory.setUpdateUserId(WebContextUtil.takeTokenFromRequest().getUserId());
