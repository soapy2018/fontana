...
import com.bluetron.nb.common.flowapi.dict.FlowVariableType;
import com.bluetron.nb.common.flowservice.entity.*;
import com.bluetron.nb.common.flowservice.listener.UpdateFlowStatusListener;
import com.bluetron.nb.common.flowservice.mapper.FlowEntryMapper;
import com.bluetron.nb.common.flowservice.mapper.FlowEntryPublishMapper;
import com.bluetron.nb.common.flowservice.mapper.FlowEntryPublishVariableMapper;
...
import com.bluetron.nb.common.flowservice.service.FlowTaskExtService;
import com.bluetron.nb.common.flowservice.util.BaseFlowDeptPostExtHelper;
import com.bluetron.nb.common.flowservice.util.FlowCustomExtFactory;
...
public class FlowEntryServiceImpl extends ABaseService<FlowEntry, Long> implements com.bluetron.nb.common.flowservice.service.FlowEntryService {
    ...
    public FlowEntry saveNew(FlowEntry flowEntry) {
        flowEntry.setEntryId(IdUtil.nextLongId());
    ...
    public void publish(FlowEntry flowEntry, String initTaskInfo, List<FlowTaskExt> flowTaskExtList) throws XMLStreamException {
        ...
        flowEntryPublish.setEntryPublishId(IdUtil.nextLongId());
        ...
        flowEntryPublish.setCreateUserId(WebContextUtil.takeTokenFromRequest().getUserId());
    ...
    public boolean update(FlowEntry flowEntry, FlowEntry originalFlowEntry) {
        flowEntry.setUpdateUserId(WebContextUtil.takeTokenFromRequest().getUserId());
    ...
    private void insertBuiltinEntryVariables(Long entryId) {
        ...
        operationTypeVariable.setVariableId(IdUtil.nextLongId());
        ...
        startUserNameVariable.setVariableId(IdUtil.nextLongId());
    ...
    private void insertEntryPublishVariables(List<FlowEntryVariable> entryVariableList, Long entryPublishId) {
        ...
        for (FlowEntryPublishVariable variable : entryPublishVariableList) {
            variable.setVariableId(IdUtil.nextLongId());
