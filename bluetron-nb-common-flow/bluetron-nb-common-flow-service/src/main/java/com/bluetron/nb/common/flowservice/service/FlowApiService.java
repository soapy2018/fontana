...
public interface FlowApiService {
     ...
     * @return 用户的任务列表。
     */
    Pagination<Task> getTaskListByUserName(String username, String definitionKey, MyPageParam pageParam);
     ...
     */
    Pagination<HistoricProcessInstance> getHistoricProcessInstanceList(
     ...
     * @throws ParseException 日期参数解析失败。
     */
    Pagination<HistoricTaskInstance> getHistoricTaskInstanceFinishedList(
            String processDefinitionName,
            String beginDate,
            String endDate,
