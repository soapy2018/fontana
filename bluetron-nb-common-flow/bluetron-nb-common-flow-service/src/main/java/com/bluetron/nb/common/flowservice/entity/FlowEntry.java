...
public class FlowEntry {
    ...
    public interface FlowEntryModelMapper extends BaseEntityMapper<FlowEntryVo, FlowEntry> {
         ...
         * @return 实体对象。
         */
        @Mapping(target = "mainFlowEntryPublish", expression = "java(mapToBean(flowEntryVo.getMainFlowEntryPublish(), com.bluetron.nb.common.flowservice.entity.FlowEntryPublish.class))")
        @Mapping(target = "flowCategory", expression = "java(mapToBean(flowEntryVo.getFlowCategory(), com.bluetron.nb.common.flowservice.entity.FlowCategory.class))")
        @Override
