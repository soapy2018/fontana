...
import com.fontana.onlineservice.mapper.OnlineColumnMapper;
import com.fontana.onlineservice.mapper.OnlineColumnRuleMapper;
...
public class OnlineColumnServiceImpl extends AbstractBaseService<OnlineColumn, Long> implements OnlineColumnService {
    ...
    public boolean updateOnlineColumnRule(OnlineColumnRule onlineColumnRule) {
        ...
        UpdateWrapper<OnlineColumnRule> uw =
                AbstractBaseService.createUpdateQueryForNullValue(onlineColumnRule, OnlineColumnRule.class);
        uw.setEntity(filter);
