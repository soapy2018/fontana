package com.bluetron.nb.common.db.object;

import cn.hutool.core.util.ReflectUtil;
import com.bluetron.nb.common.base.constant.CommonConstants;
import com.bluetron.nb.common.base.exception.InvalidClassFieldException;
import com.bluetron.nb.common.base.exception.InvalidDataFieldException;
import com.bluetron.nb.common.base.exception.InvalidDataModelException;
...
public class MyOrderParam extends ArrayList<MyOrderParam.OrderInfo> {
    ...
    private static void processOrderInfo(
        ...
        if (StringUtils.isNotBlank(orderInfo.dateAggregateBy)) {
            ...
            if (CommonConstants.DAY_AGGREGATION.equals(orderInfo.dateAggregateBy)) {
                orderByBuilder.append(", '%Y-%m-%d')");
            } else if (CommonConstants.MONTH_AGGREGATION.equals(orderInfo.dateAggregateBy)) {
                orderByBuilder.append(", '%Y-%m-01')");
            } else if (CommonConstants.YEAR_AGGREGATION.equals(orderInfo.dateAggregateBy)) {
