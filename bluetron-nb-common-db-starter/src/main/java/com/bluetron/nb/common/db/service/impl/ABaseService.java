...
import com.bluetron.nb.common.util.tools.AopTargetUtil;
 ...
 */
@Slf4j
public abstract class ABaseService<M, K extends Serializable> extends ServiceImpl<BaseDaoMapper<M>, M> implements IBaseService<M, K> {
    /**
     ...
     */
        ...
        for (RelationStruct relationStruct : this.relationOneToOneStructList) {
            ...
            if (CollectionUtils.isNotEmpty(masterIdSet)) {
                ABaseService<Object, Serializable> relationService = relationStruct.service;
                ...
                if (withDict && relationStruct.relationOneToOne.loadSlaveDict()
                    ...
                    @SuppressWarnings("unchecked")
                    ABaseService<Object, Serializable> proxyTarget =
                            (ABaseService<Object, Serializable>) AopTargetUtil.getTarget(relationService);
                    // 关联本地字典。
    ...
    protected UpdateWrapper<M> createUpdateQueryForNullValue(M o, K id) {
        ...
        try {
            ...
            log.error("Failed to call reflection code of BaseServiceImpl.createUpdateQueryForNullValue.", e);
    ...
    private void initializeRelationStruct(Field f) {
        ...
        if (relationOneToOne != null) {
            ...
            if (StringUtils.isNotBlank(relationOneToOne.slaveServiceName())) {
                ...
                relationStruct.service = (ABaseService<Object, Serializable>)
    ...
    static class RelationStruct {
        ...
        private ABaseService<Object, Serializable> service;
