...
public interface BaseClient<D, V, K> {
     ...
     * @return 应答结果对象，主键Id。
     */
    default Result<V> saveNewOrUpdate(D data) {
     ...
     * @return 应答结果对象。
     */
    default Result<Void> saveNewOrUpdateBatch(List<D> dataList) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 应答结果对象。
     */
    default Result<Void> verifyRelatedData(D data) {
        throw new UnsupportedOperationException();
    }
     ...
     * @return 应答结果对象。
     */
    default Result<Void> verifyRelatedDataList(List<D> dataList) {
        throw new UnsupportedOperationException();
    }
     ...
     */
    default Result<List<?>> notExist(MyQueryParam queryParam) {
        throw new UnsupportedOperationException();
    }
}
